...
import { Header, Footer, Steps } from "../../components/onBoarding";
      ...
      <div className=" w-full lg:w-5/12 xl:w-5/12 px-2 lg:px-5 xl:px-5 py-5 lg:py-0 xl:py-0">
        <div class="w-full">
          ...
          <div className="flex justify-center py-5  text-2xl">
              Related &nbsp; <span className="font-bold ">Execellent</span> &nbsp;on &nbsp;<span className=" "> <img className="h-7"  src={StarGreen} alt="" /> </span> &nbsp;Trustpilot
          </div>
        </div>
      </div>
    </main>
