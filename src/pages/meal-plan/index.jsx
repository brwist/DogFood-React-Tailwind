    ...
    return (
      <div className="md:bg-white sm:px-2 md:px-4 xl:px-0">
        <div className="justify-center mb-5 customContainer md:border  border-gray-200 p-4 rounded-lg">
          ...
          />
          <button className="border border-green-700 hover:border-transparent focus:outline-none bg-green-600 text-white font-bold text-sm md:text-base w-52  md:px-5 rounded border-green  mt-10 py-4 m-0">
            Save changes
          </button>
        </div>
      </div>
