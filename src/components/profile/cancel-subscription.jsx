      ...
      <React.Fragment>
        <div className="grid lg:grid-cols-2 xs:grid-cols-1">
          <div className="bg-green-50 pt-5 pl-6 pr-6 md:hidden">
            <h3 className="font-medium text-xl font-messina text-copyPrimary flex items-center">
              {" "}
              <DogIcon className="mr-4" /> Manage Subscription
            </h3>
            <p className="mt-8 text-3xl font-cooper">We'll be waiting for you to come back</p>
          ...
          <div className="bg-white">
            <div className="w-auto">
              ...
              <div className="mt-10 px-10">
                <CancelOptions
                  currentDog={this.props.dogs.length > 0 && this.props.dogs[this.state.dogIndex]}
