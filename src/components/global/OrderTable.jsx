  ...
  <div className="shadow-tableBoxShadow rounded-lg border pt-5 md:py-5 border-dullishWhite m-4 md:m-0">
    ...
    <div className="px-5 ">
      ...
      <table className="table-fixed w-full hidden md:block">
        ...
        <tbody>
          {orders.map(({
            ...
            >
              <td className="text-sm p-4 2/10">
                <p className="pb-1">{date}</p>
                <a className="text-green-500 ">View Order</a>
              </td>
              <td className="text-sm  p-4 2/10">
                <span>{total}</span>
                <br />
              </td>
              <td className="text-sm px-4 py-3 w-4/10">{plan}</td>
              <td className="text-sm px-4 py-3 2/10">{payment_status}</td>
            </tr>
          ))}
        </tbody>
      </table>
      ...
      {orders.map(({
        ...
        >
          <p className="text-xs pb-2">Shipped</p>
          <h2 className="text-lg font-bold pb-2">{date}</h2>
          <p className="text-sm pb-2">{total}</p>
          <p className="text-sm pb-2">{plan}</p>
          <a className="text-green-500 pb-2">View Order</a>
        </div>
      ))}
    </div>
  </div>
